...
st.markdown("""
    ...
    /* 💥 ไม่ไปยุ่งกับสีปุ่ม Primary (รันตาราง/Save) เพิ่มแค่ Transition กับเงามีมิติ */
    .stButton>button {
    ...
    /* 💥 Tab ด้านบน และการล็อกสีตัวหนังสือไม่ให้จมหายใน Dark Mode */
    ...
    .stTabs [data-baseweb="tab"] p {
        color: #154360 !important; /* ล็อกสีอักษรเป็นน้ำเงินเข้มเสมอ */
    ...
    /* 💥 ซ่อนจุดวงกลมของ Radio Button อย่างเด็ดขาด */
    [data-testid="stSidebar"] [data-baseweb="radio"] > div:first-child {
        display: none !important;
    }
    
    /* 💥 สไตล์ปุ่มเมนูให้ดูแบนเรียบ และไฮไลต์เมื่อเปิดใช้งาน */
    ...
    /* 💥 ปุ่ม Logout ให้กลืนไปกับ Sidebar อย่างเนียนตา */
...
def get_cell_bg_hex(val_str):
    ...
    return "F5F5F5" # สีพื้นหลังของงาน Back Office, ออกเวร, งานพิเศษ 
                    ...
                    for col_idx in range(1, len(df_schedule.columns) + 1):
                        ...
                        for row_idx in range(3, len(df_schedule) + 4): 
                            ...
                            if row_idx == 3 and col_idx >= 2:
                                ...
                                if bg_hex: # 💥 ใส่สี F5F5F5 ให้อย่างสมบูรณ์
    ...
    if st.session_state.gen_df is not None:
        ...
        <head>
            ...
            <style>
                ...
                .btn-img {{ width: 100%; background-color: transparent; color: #31333F; padding: 0.5rem 1rem; border: 1px solid #e0e0e0; border-radius: 8px; cursor: pointer; font-size: 16px; font-weight: 500; font-family: 'Kanit', sans-serif; transition: all 0.2s ease; display: flex; align-items: center; justify-content: center; height: 42px; }}
                .btn-img:hover {{ border-color: #e0e0e0; color: #ff4b4b; border: 1px solid #ff4b4b; transform: translateY(-2px); }}
