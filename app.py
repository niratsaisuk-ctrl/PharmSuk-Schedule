...
with st.sidebar:
    ...
    st.markdown("<br><hr style='margin:0; border-color: rgba(255,255,255,0.1);'><p style='text-align:center; color:rgba(255,255,255,0.4); font-size:12px; margin-top:5px;'>💡 PharmSuk v42</p>", unsafe_allow_html=True)
...
if page == "🗓️ ปฏิทินห้องยา & ลงข้อมูล":
    ...
    # 💥 เปลี่ยน st.tabs หลักเป็น st.radio เพื่อแก้ปัญหาปฏิทินไม่วาดตัวตอนซ่อนอยู่
    sub_page = st.radio("เลือกหน้าต่างการทำงาน:", ["📅 ดูปฏิทินรวม", "📝 ฟอร์มลงข้อมูล", "📋 จัดการข้อมูลของคุณ"], horizontal=True, label_visibility="collapsed")
    st.write("---")
    ...
    elif sub_page == "📋 จัดการข้อมูลของคุณ":
