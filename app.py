...
with st.sidebar:
    ...
    # 💥 แก้ไขโครงสร้างเมนู แยกปฏิทิน และการจัดการออกจากกัน
    menu_options = [
        "🗓️ ปฏิทินห้องยา", 
    ...
    st.markdown("<br><hr style='margin:0; border-color: rgba(255,255,255,0.1);'><p style='text-align:center; color:rgba(255,255,255,0.4); font-size:12px; margin-top:5px;'>💡 PharmSuk v43</p>", unsafe_allow_html=True)

# ==================================================================
# หน้า 1.1: 🗓️ ปฏิทินห้องยา (เมนูเดี่ยวๆ ไม่มีแท็บซ้อน)
# ==================================================================
...
# ==================================================================
    ...
    # ใช้ Tabs แบบดั้งเดิมของ Streamlit
