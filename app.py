...
# ==================================================================
    ...
    # 💥 จัดระเบียบปุ่มให้เรียงติดกันในบรรทัดเดียว
    if st.session_state.gen_df is not None:
        ...
        <head>
            ...
            <style>
                ...
                /* ปุ่มนี้ออกแบบให้เหมือนปุ่ม Streamlit ทุกประการ */
                .btn-img {{ width: 100%; background-color: transparent; color: #31333F; padding: 0.5rem 1rem; border: 1px solid #e0e0e0; border-radius: 8px; cursor: pointer; font-size: 16px; font-weight: 500; font-family: 'Kanit', sans-serif; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center; height: 42px; }}
                .btn-img:hover {{ border-color: #9B59B6; color: #9B59B6; transform: translateY(-2px); box-shadow: 0 4px 10px rgba(0,0,0,0.1); }}
                #capture-area-wrapper {{ position: relative; width: 100%; overflow-x: auto; padding-bottom: 10px; }}
                
                /* จัดปุ่มให้อยู่ล่างซ้ายให้ดูเหมือนเป็น Grid CSS */
        ...
        # กล่องซ่อนตาราง (คำนวณความสูงให้พอดี ไม่ให้มีแถบเลื่อนแนวตั้ง)
        components.html(full_html, height=730, scrolling=False)
        
        # ปุ่ม Streamlit อีก 2 ปุ่ม ให้อยู่ระดับเดียวกันกับปุ่มรูปภาพ
