...
# 💥 แก้ไขให้ดึงวันหยุดครอบคลุม 3 ปี (ปีที่แล้ว, ปีนี้, ปีหน้า)
...
with st.sidebar:
    ...
    st.markdown("<br><hr style='margin:0; border-color: rgba(255,255,255,0.1);'><p style='text-align:center; color:rgba(255,255,255,0.4); font-size:12px; margin-top:5px;'>💡 PharmSuk v41</p>", unsafe_allow_html=True)
