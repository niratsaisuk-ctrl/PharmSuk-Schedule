...
st.markdown("""
    ...
    /* 💥 สีแถบเมนูข้าง (Sidebar) โทนเดียวกับ Banner */
    ...
    /* 💥 ทำเมนูให้เป็นปุ่มกด กลืนไปกับพื้นหลัง */
    ...
    /* 💥 สีตอนกดเลือก Active เด่นชัด ต่างจากปุ่มปกติ */
    ...
    /* 💥 ปุ่ม Logout ให้กลืนไปกับ Sidebar ไม่แย่งซีน */
    ...
    with tab_sh:
        ...
        with st.expander("➕ เพิ่มการออกเวรหน้างาน"):
            ...
            if add_sh_t == "ออกเวรดึก":
                sc1, sc2 = st.columns(2) # 💥 ซ่อมจุดผิดของตัวแปรคอลัมน์แล้ว
