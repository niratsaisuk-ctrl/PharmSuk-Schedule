...
# ==================================================================
    ...
    # 💥 ดึงปุ่มรูปภาพมาไว้บนสุดในเฟรม ไม่ให้โดนตารางบัง
    if st.session_state.gen_df is not None:
        full_html = f"""
        <!DOCTYPE html>
        <html>
        <head>
            ...
            <style>
                ...
                .btn-img {{ background-color: #ffffff; color: #31333F; padding: 0 2rem; border: 1px solid rgba(49, 51, 63, 0.2); border-radius: 8px; cursor: pointer; font-size: 16px; font-weight: 500; font-family: 'Kanit', sans-serif; transition: all 0.2s ease; height: 40px; display: inline-flex; align-items: center; justify-content: center; }}
        ...
        # เปิดความสูงเยอะๆ และ Scrolling=True ให้เลื่อนดูตารางยาวๆ ได้เต็มที่
