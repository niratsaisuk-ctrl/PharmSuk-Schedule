...
with st.sidebar:
    ...
    st.markdown("<br><hr style='margin:0; border-color: rgba(255,255,255,0.1);'><p style='text-align:center; color:rgba(255,255,255,0.4); font-size:12px; margin-top:5px;'>💡 PharmSuk v45</p>", unsafe_allow_html=True)
...
# ==================================================================
    ...
    with tab_lock:
        ...
        with st.expander("➕ เพิ่มการล็อก/เว้น"):
            ...
            # 💥 แก้ไขจุดที่เกิด Error ชื่อไม่ตรง
            if l_t == "ล็อกภาระงานหลัก":
                l_task = st.selectbox("เลือกภาระงานหลัก", base_main_tasks + ["Matching"], key="l_task")
