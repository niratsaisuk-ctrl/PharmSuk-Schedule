...
st.markdown("""
    ...
    html, body, [class*="css"], .stMarkdown, .stText, p, h1, h2, h3, h4, h5, h6 { font-family: 'Kanit', sans-serif !important; }
...
with st.sidebar:
    ...
    # ย้ายปุ่มออกจากระบบมาไว้ใต้ชื่อตามต้องการ
...
# หากมีคนยกเลิก คิวคนอื่นจะถูกดันขึ้นอัตโนมัติ
# ==================================================================
leave_queues = {}
leaves_by_date = {}
...
# ==================================================================
    ...
    with tab_history:
        ...
        if not history_my_reqs: st.info("ไม่มีประวัติคำขอ")
        else:
    ...
    if current_view == "ผู้ช่วยเภสัชกร":
        ...
        if st.session_state.gen_df is not None:
            ...
            if col_dl2.button("💾 บันทึกตารางลง Database", use_container_width=True):
                if save_schedule_to_db(target_date_str, st.session_state.gen_html): st.toast("บันทึกตารางสำเร็จ! ✅")
