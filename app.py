    ...
    with col2:
        if st.session_state.get('auth_mode', 'login') == 'login':
            with st.form("login_form"):
                ...
                # 💥 1. รองรับการกรอก Username หรือ Email
                login_val = st.text_input("Username หรือ Email")
                password = st.text_input("Password", type="password")
                
                # 💥 2. เอาปุ่มลืมรหัสผ่านเข้ามาไว้ใน form เคาะเรียงกันสวยๆ
            ...
            with st.form("forgot_form"):
                ...
                # จัดปุ่มให้อยู่ใน Form เช่นเดียวกัน
...
with st.sidebar:
    ...
    st.markdown("<br><hr style='margin:0; border-color: rgba(255,255,255,0.1);'><p style='text-align:center; color:rgba(255,255,255,0.4); font-size:12px; margin-top:5px;'>💡 PharmSuk v40</p>", unsafe_allow_html=True)
