...
# --- ระบบจัดเรียงลำดับแบบไดนามิก และค้นหา Role: Head ---
...
with st.sidebar:
    ...
    # ให้สิทธิ์ "Head" เข้าถึงเมนูเดียวกับ "Admin"
...
# ==================================================================
    ...
    with tab_form:
        ...
        # สิทธิ์ Head สามารถเพิ่มฟังก์ชันเดียวกับ Admin
        if user_info['role'] in ['Admin', 'Head']: 
...
# ==================================================================
    ...
    if st.button("🚀 ประมวลผลสมองกล AI สร้างตาราง", type="primary", use_container_width=True):
        with st.spinner("🤖 AI กำลังคำนวณตำแหน่งและบล็อกเวลา..."):
            ...
            # ส่ง head_pharmacist_list ที่ดึงจาก Database ไปให้ AI จัดการ
